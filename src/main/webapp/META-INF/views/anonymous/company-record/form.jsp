...
<acme:form readonly="true">
	<acme:form-textbox code="anonymous.company-record.form.label.incorporated" path="incorporatedName"/>
	<acme:form-textbox code="anonymous.company-record.form.label.sector" path="sector"/>
	<acme:form-textbox code="anonymous.company-record.form.label.nameCEO" path="nameCEO"/>
	...
	<acme:form-textbox code="anonymous.company-record.form.label.phoneNumber" path="phoneNumber"/>
